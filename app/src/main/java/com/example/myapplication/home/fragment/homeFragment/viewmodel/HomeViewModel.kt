package com.example.myapplication.home.fragment.homeFragment.viewmodel
...
import com.example.myapplication.util.Constants.Companion.COLLECTION_PATH_NOTIFICATION
...
data class Counts(
    ...
    @SuppressLint("RestrictedApi") var user: User? = null
)